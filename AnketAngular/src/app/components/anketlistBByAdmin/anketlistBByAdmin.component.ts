...
@Component({
  selector: 'app-anketlistBByAdmin',
  templateUrl: './anketlistBByAdmin.component.html',
  styleUrls: ['./anketlistBByAdmin.component.scss']
})
export class AnketlistBByAdminComponent implements OnInit {
